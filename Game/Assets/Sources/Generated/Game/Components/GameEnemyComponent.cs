...
public partial class GameEntity {
    ...
    public Enemy enemy { get { return (Enemy)GetComponent(GameComponentsLookup.Enemy); } }
    public bool hasEnemy { get { return HasComponent(GameComponentsLookup.Enemy); } }

    public void AddEnemy(string newType) {
        var index = GameComponentsLookup.Enemy;
        var component = (Enemy)CreateComponent(index, typeof(Enemy));
        component.type = newType;
        AddComponent(index, component);
    }

    public void ReplaceEnemy(string newType) {
        var index = GameComponentsLookup.Enemy;
        var component = (Enemy)CreateComponent(index, typeof(Enemy));
        component.type = newType;
